...
var statsdPacketTests = []struct {
	...
	{"test", "IncFloat", "count", float64(1.1), 0.999999, "test.count:1.1|c|@0.999999"},
	{"test", "Inc", "count", int64(1), 1.0, "test.count:1|c"},
	{"test", "IncFloat", "count", float64(1.0), 1.0, "test.count:1|c"},
	{"test", "Dec", "count", int64(1), 1.0, "test.count:-1|c"},
	{"test", "DecFloat", "count", float64(1), 1.0, "test.count:-1|c"},
	{"test", "Timing", "timing", int64(1), 1.0, "test.timing:1|ms"},
	{"test", "TimingFloat", "timing", float64(1.2), 1.0, "test.timing:1.2|ms"},
	...
	{"", "IncFloat", "count", float64(1.1), 0.999999, "count:1.1|c|@0.999999"},
	{"", "Inc", "count", int64(1), 1.0, "count:1|c"},
	{"", "IncFloat", "count", float64(1.0), 1.0, "count:1|c"},
	{"", "Dec", "count", int64(1), 1.0, "count:-1|c"},
	{"", "DecFloat", "count", float64(1.2), 1.0, "count:-1.2|c"},
	{"", "Timing", "timing", int64(1), 1.0, "timing:1|ms"},
	{"", "TimingFloat", "timing", float64(1.1), 1.0, "timing:1.1|ms"},
